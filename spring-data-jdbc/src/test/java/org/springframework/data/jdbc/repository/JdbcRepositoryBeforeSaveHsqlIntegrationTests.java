...
public class JdbcRepositoryBeforeSaveHsqlIntegrationTests {
	...
	public void mutableEntity() {
		...
		assertThat(mutableEntityRepository.findAll()).hasSize(1);
	}
	...
	public void mutableWithImmutableIdEntity() {
		...
		assertThat(mutableWithImmutableIdEntityRepository.findAll()).hasSize(1);
	}
	...
	public void immutableWithMutableIdEntity() {
		...
		assertThat(immutableWithMutableIdEntityRepository.findAll()).hasSize(1);
	}

	private interface ImmutableEntityRepository extends CrudRepository<ImmutableEntity, Long> {}
	...
	private interface MutableEntityRepository extends CrudRepository<MutableEntity, Long> {}
	...
	private interface MutableWithImmutableIdEntityRepository extends CrudRepository<MutableWithImmutableIdEntity, Long> {}
	...
	private interface ImmutableWithMutableIdEntityRepository extends CrudRepository<ImmutableWithMutableIdEntity, Long> {}
